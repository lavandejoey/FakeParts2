...
#SBATCH --output=logs/DiffusersT2V_CosmosPredict2_%j.out
#SBATCH --error=logs/DiffusersT2V_CosmosPredict2_%j.err
...
srun python3 -W ignore \
  ./DiffusersV2V_CosmosPredict2.py \
...
#  -o "/projects/hi-paris/DeepFakeDataset/DeepFake_V2/V2V/nvidia/Cosmos-Predict2-14B-Video2World" \
#  -n 500
# python3 ~/FakeParts2/Extrapolation/CosmosPredict2/DiffusersV2V_CosmosPredict2.py -v "/projects/hi-paris/DeepFakeDataset/DeepFake_V2/10k_real" -o "/projects/hi-paris/DeepFakeDataset/DeepFake_V2/V2V/nvidia/Cosmos-Predict2-2B-Video2World" -n 500
