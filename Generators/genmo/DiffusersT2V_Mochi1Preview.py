#!/usr/bin/env python3
"""
Diffusers Text-to-Video Generation using Mochi 1 Preview model.
...
Usage:
    python3 DiffusersT2V_Mochi1Preview.py -p <prompt_path> -o <output_path> [options]
Options:
...
def setup_pipeline() -> MochiPipeline:
    # ========== Pipline setup  ==========
    logging.info(f"Loading MochiPipeline model {MODEL_PARAMS['pretrained_model_name_or_path']}...")
...
def generate_video(args: argparse.Namespace, pipe: MochiPipeline,
