#!/usr/bin/env python3
"""
Diffusers Text-to-Video Generation using CogVideoX model
...
- FPS: 25
- Length: 5s
- w*h: 720 x 480, no support for other resolutions (including fine-tuning)

Usage:
    python3 DiffusersT2V_CogVideoX.py -p <prompt_path> -o <output_path> [options]
Options:
...
logging.info("===== Starting Diffusers Text-to-Video Generation using CogVideoX model =====")
...
def setup_pipeline() -> CogVideoXPipeline:
    # ========== Pipline setup  ==========
    logging.info(f"Loading CogVideoXPipeline model {MODEL_PARAMS['pretrained_model_name_or_path']}...")
...
def generate_video(args: argparse.Namespace, pipe: CogVideoXPipeline,
